package  {
	...
	public class Main extends MovieClip {
		...
		private var sasworiClass:SasworiClass;
		...
		private function callGames():void
		{
			...
			sasworiClass = new SasworiClass(_stageWidth, _stageHeight);
			addChild(zgarbi);
			
			zgarbi.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
			sasworiClass.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
		}
