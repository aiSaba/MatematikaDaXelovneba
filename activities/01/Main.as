package  {
	...
	public class Main extends MovieClip {
		...
		private var pirveliStage:PirveliStage;
		...
		private function callGames():void
		{
			...
			pirveliStage = new PirveliStage(_stageWidth, _stageHeight);
			addChild(zgarbi);
			
			zgarbi.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
			pirveliStage.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
		}
