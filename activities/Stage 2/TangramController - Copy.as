package  {
	...
	public class TangramController extends MovieClip {
		
		private var _stageWidth:Number;
		private var _stageHeight:Number;
		private var zgarbi:Zgarbi;
		private var addTangram:AddTangram;
		private var timerC:TimerClass;
		private var qula:int;
		
		public function TangramController() 
		{
		...
		private function callGames():void
		{
			...
			addTangram = new AddTangram(_stageWidth, _stageHeight);
			addChild(zgarbi);
			
			zgarbi.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
			addTangram.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
		}
