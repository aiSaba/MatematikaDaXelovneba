package  {
	...
	public class Main extends MovieClip {
		...
		private var stage5Class:Stage5Class;
		...
		private function callGames():void
		{
			...
			stage5Class = new Stage5Class(_stageWidth, _stageHeight);
			addChild(zgarbi);
			
			zgarbi.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
			stage5Class.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
		}
