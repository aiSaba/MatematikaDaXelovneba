package  {
	...
	public class Main extends MovieClip {
		...
		private var stage7Class:Stage7Class;
		...
		private function callGames():void
		{
			...
			stage7Class = new Stage7Class(_stageWidth, _stageHeight);
			addChild(zgarbi);
			
			zgarbi.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
			stage7Class.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
		}
