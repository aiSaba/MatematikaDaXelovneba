package  {
	...
	public class Main extends MovieClip {
		...
		private var stage6Class:Stage6Class;
		...
		private function callGames():void
		{
			...
			stage6Class = new Stage6Class(_stageWidth, _stageHeight);
			addChild(zgarbi);
			
			zgarbi.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
			stage6Class.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
		}
