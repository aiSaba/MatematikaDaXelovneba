package  {
	...
	public class Main extends MovieClip {
		...
		private var cardsClass:CardsClass;
		...
		private function callGames():void
		{
			...
			cardsClass = new CardsClass(_stageWidth, _stageHeight);
			addChild(zgarbi);
			
			zgarbi.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
			cardsClass.addEventListener(DataEvent.DATA, beforeStage, false, 0, true);
		}
